...
import (
	...
	"dev.khulnasoft.com/api/v4/pkg/auth"
	loftclientset "dev.khulnasoft.com/api/v4/pkg/clientset/versioned"
...
func (cmd *StartCmd) runInDocker(ctx context.Context, name string) (string, error) {
	...
	if cmd.DockerImage != "" {
		...
		args = append(args, "ghcr.io/khulnasoftdevspace-pro:"+strings.TrimPrefix(cmd.Version, "v"))
	} else {
