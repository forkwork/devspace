...
When you open the workspace, the DevPod logs give you the user/machine combination you'll need to connect to the workspace, usually in the format of `WORKSPACE_NAME.devspace` 
...
To connect to the workspace, run the command DevPod gives you after starting the workspace, usually `ssh WORKSPACE_NAME.devspace`.
