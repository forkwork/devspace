...
To get started with DevPod, choose either the [DevPod Desktop](#install-devspace) application or the [DevPod CLI](#install-devspace-cli).
...
- [Linux Targz](https://dev.khulnasoft.com/releases/latest/download/DevPod_linux_x86_64.tar.gz)
