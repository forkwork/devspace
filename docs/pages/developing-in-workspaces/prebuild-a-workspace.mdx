...
Based on the `devcontainer.json` configuration, DevPod will generate a hash in the form of `devspace-HASH` and use this as a tag for the created docker image.
