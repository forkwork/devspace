...
import (
	clusterv1 "dev.khulnasoft.com/agentapi/v4/pkg/apis/loft/cluster/v1"
...
// +genclient
// +genclient:noStatus
// +genclient:method=GetKubeConfig,verb=create,subresource=kubeconfig,input=dev.khulnasoft.com/api/v4/pkg/apis/management/v1.VirtualClusterInstanceKubeConfig,result=dev.khulnasoft.com/api/v4/pkg/apis/management/v1.VirtualClusterInstanceKubeConfig
// +genclient:method=GetAccessKey,verb=get,subresource=accesskey,result=dev.khulnasoft.com/api/v4/pkg/apis/management/v1.VirtualClusterAccessKey
// +genclient:method=GetExternalDatabase,verb=create,subresource=externaldatabase,input=dev.khulnasoft.com/api/v4/pkg/apis/management/v1.VirtualClusterExternalDatabase,result=dev.khulnasoft.com/api/v4/pkg/apis/management/v1.VirtualClusterExternalDatabase
