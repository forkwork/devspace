...
import (
	...
	_ "dev.khulnasoft.com/api/v4/pkg/apis/management/install" // Install the management group
	managementv1 "dev.khulnasoft.com/api/v4/pkg/apis/management/v1"
	"dev.khulnasoft.com/api/v4/pkg/apis/virtualcluster"
	_ "dev.khulnasoft.com/api/v4/pkg/apis/virtualcluster/install" // Install the virtualcluster group
	virtualclusterv1 "dev.khulnasoft.com/api/v4/pkg/apis/virtualcluster/v1"
